...
The threshold counts `Broadcasted` nodes in the expression tree. Changing it requires a Julia restart. `CUNUMERIC_FUSE_BROADCAST_MIN_OPS` can override the preference in CI; see [Configuration](../configuration.md).
