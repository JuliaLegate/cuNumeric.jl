...
<<<<<<< HEAD void wrap_unary_ops(jlcxx::Module& mod) {
...
>>>>>>> main
  ...
  void wrap_unary_reds(jlcxx::Module & mod) {
    ...
    mod.set_const("CONTAINS",
                  CuPyNumericUnaryRedCode::CUPYNUMERIC_RED_CONTAINS);
    ...
    mod.set_const("VARIANCE",
                  CuPyNumericUnaryRedCode::CUPYNUMERIC_RED_VARIANCE);
  }
  ...
  void wrap_binary_ops(jlcxx::Module & mod) {
    ...
    mod.set_const("ARCTAN2",
                  CuPyNumericBinaryOpCode::CUPYNUMERIC_BINOP_ARCTAN2);
    ...
    mod.set_const("GREATER",
                  CuPyNumericBinaryOpCode::CUPYNUMERIC_BINOP_GREATER);
    ...
    mod.set_const("ISCLOSE",
                  CuPyNumericBinaryOpCode::CUPYNUMERIC_BINOP_ISCLOSE);
    ...
    mod.set_const("MAXIMUM",
                  CuPyNumericBinaryOpCode::CUPYNUMERIC_BINOP_MAXIMUM);
    mod.set_const("MINIMUM",
                  CuPyNumericBinaryOpCode::CUPYNUMERIC_BINOP_MINIMUM);
