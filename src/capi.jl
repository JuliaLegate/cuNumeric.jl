...
const CNType_t = Ptr{Legate.LegateTypeAllocated}
...
nda_array_type(arr::NDArray) = ccall((:nda_array_type, libnda),
                                CNType_t, (NDArray_t,), arr.ptr)

nda_array_type_code(arr::NDArray) = ccall((:nda_array_type, libnda),
                                      Int32, (NDArray_t,), arr.ptr)
